...
```js
* Dev: `npm i https://github.com/vkamsingh/Ferralink-Dev.git` //Dev version supports lavalink v4. get more information [here](https://github.com/vkamsingh/Ferralink-Dev)
