...
client.FerraLink = new FerraLink({
    ...
    defaultSearchEngine: "FerralinkSpotify || youtube || youtubemusic || soundcloud || spotify",
...
const resolve = await player.search(args.join(" ")); // spsearch is work for search spotify tracks.
